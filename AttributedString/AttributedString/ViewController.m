...
- (void)secondMethod{
    ...
    //设置笔画宽度和填充部分颜色
    NSString *str6 = @"\n设置笔画宽度和填充颜色\n";
    NSDictionary *dictAttr6 = @{NSStrokeWidthAttributeName:@(6),NSStrokeColorAttributeName:[UIColor blueColor]};
    ...
    /*问题代码
     ...
     textAttachment.image = [UIImage imageNamed:@"timeline_icon_unlike"];
    ...
    NSString *str9 = @"文字的图文混排";
    [attributedString appendAttributedString:[[NSAttributedString alloc] initWithString:str9]];
    NSTextAttachment *textAttachment = [[NSTextAttachment alloc]init];
    textAttachment.image = [UIImage imageNamed:@"timeline_icon_unlike"];
    textAttachment.bounds = CGRectMake(0, 0, 30, 30);    NSAttributedString *attr9 = [NSAttributedString attributedStringWithAttachment:textAttachment];
    [attributedString appendAttributedString:attr9];
    ...
    NSDictionary *dictAttr14 = @{NSWritingDirectionAttributeName:@[@(NSWritingDirectionRightToLeft | NSWritingDirectionOverride)]};
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(60, 20, 300, 0)];
